   ...
   <Card style={{ width: '36rem',height:'30rem', backgroundColor: 'rgba(255, 255, 255, 0.7)' }}>
     ...
     <Card.Body>
      ...
      {user && <p >Name:{user.name}</p>}
       ...
       <Button variant="primary" className="flex-grow-1  mb-2 mt-5 mx-2" onClick={()=> navigate('/updateuser')}>Edit</Button>
       <Button variant="danger" className="flex-grow-1 mx-2"   onClick={() => deleteHandler(user._id)}>Delete</Button>
       </div>
     </Card.Body>
   </Card>
